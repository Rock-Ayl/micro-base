...
public class AssertExtraUtils {
     ...
     */
    public static <T, R> void assertFail(MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //抛出
        throw new MyException(myExceptionEnum, errorKey, errorValueList);
    }
     ...
     * @param errorValueList  错误的值列表
     */
    public static <T, R> void assertTrue(boolean bool, MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //判断
        if (bool == false) {
            //抛出
            throw new MyException(myExceptionEnum, errorKey, errorValueList);
     ...
     * @param myExceptionEnum 要抛出的枚举
     * @param errorKey        错误key
     * @param errorValueList  错误的值列表ø
     */
    public static <T, R> void assertFalse(boolean bool, MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //判断
        if (bool == true) {
            //抛出
            throw new MyException(myExceptionEnum, errorKey, errorValueList);
     ...
     * @param errorValueList  错误的值列表
     */
    public static <T, R> void assertNotNull(Object obj, MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //判断
        if (obj == null) {
            //抛出
            throw new MyException(myExceptionEnum, errorKey, errorValueList);
     ...
     * @param errorValueList  错误的值列表
     */
    public static <T, R> void assertNotEmpty(String obj, MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //判断
        if (StringUtils.isEmpty(obj)) {
            //抛出
            throw new MyException(myExceptionEnum, errorKey, errorValueList);
     ...
     * @param errorValueList  错误的值列表
     */
    public static <T, R> void assertNotBlank(String obj, MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //判断
        if (StringUtils.isBlank(obj)) {
            //抛出
            throw new MyException(myExceptionEnum, errorKey, errorValueList);
     ...
     * @param errorValueList  错误的值列表
     */
    public static <T, R> void assertNotEmpty(Collection collection, MyExceptionEnum myExceptionEnum, LambdaParseFieldNameExtraUtils.MFunction<T, R> errorKey, List<String> errorValueList) {
        //判空
        if (CollectionUtils.isEmpty(collection) || collection.size() < 1) {
            //抛出
            throw new MyException(myExceptionEnum, errorKey, errorValueList);
